...
Note that previous versions of the Boilerplate did not include `Fflassist_Core_Functionality_Loader` but this class is used to register all filters and actions with WordPress.
